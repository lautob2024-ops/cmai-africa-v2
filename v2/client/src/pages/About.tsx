  ...
  return (
    <PageShell title="À propos de CMAI+Africa" kicker="Notre projet" description="Les mathématiques pour comprendre. L'informatique pour construire. L'intelligence artificielle pour innover.">
      <div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        <section className="rounded-3xl border border-[#dbe1ea] bg-white p-7 leading-8 text-[#3a4658]">
          <h2 className="font-display text-2xl font-semibold text-[#14213d]">Une communauté africaine qui avance pas à pas</h2>
        ...
        <section className="rounded-3xl bg-[#14213d] p-7 text-white">
          ...
          <p className="mt-6 text-sm text-white/70">Abomey, Bénin</p>
        </section>
      </div>
    </PageShell>
  );
